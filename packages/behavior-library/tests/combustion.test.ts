import { createSpread, createSmoke, createExtinguish, createSpawn } from '../src/behaviors/combustion';
...
describe('combustion behaviors', () => {
  ...
  test('createSpread always spreads with prob=1', () => {
    ...
    spread({} as any, center, grid, newGrid, dims);
  ...
  test('createSmoke produces smoke above with prob=1', () => {
    ...
    smoke({} as any, center, grid, newGrid, dims);
  ...
  test('createExtinguish turns cell to ash with deathProb=1', () => {
    ...
    const did = extinguish({} as any, center, grid, newGrid, dims);
  ...
  test('createSpawn spawns cinder with prob=1', () => {
    ...
    const did = spawn({} as any, center, grid, newGrid, dims);
